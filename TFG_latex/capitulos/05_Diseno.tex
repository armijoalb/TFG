...
\end{itemize}
\vspace{0.06in}
Por último, en la quinta imagen \ref{fig:solution_recycler_diagram} se muestra el diagrama de clases de la clase \textbf{SolutionFragment}. A continuación se describen cada una de las clases que se muestran en el diagrama:
\begin{itemize}
	\item La clase \textbf{SolutionFragment} se ha definido en la imagen anterior. Es la encargada de gestionar todas las vistas que muestran la solución.
...
{%
	...
	\captionof{figure}{Diagrama de clases del activity \textbf{ResultActivity}}
	\par
}
\restoregeometry
...
{%
	...
	\captionof{figure}{Diagrama de clases de la clase \textbf{SolutionFragment}}
	\par
}
\restoregeometry
